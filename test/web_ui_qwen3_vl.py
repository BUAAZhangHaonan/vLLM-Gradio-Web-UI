...
python3 web_ui_qwen3_vl.py --openai-base-url http://172.17.43.70:8000/v1 --openai-api-key g203 --model qwen3-vl-30b-a3b-thinking --ui-host 0.0.0.0 --ui-port 7860
...
def build_app(client: OpenAI, model_name: str, max_tokens: int, temperature: float, top_p: float,
    ...
    with gr.Blocks() as demo:
        ...
        chatbot = gr.Chatbot(label="Qwen3-VL", height=520)
